...
Robotics & Embedded: Raspberry Pi, Arduino, sensors, motor control.
Computer Vision & AI: OpenCV, MobileNet, object detection, distance estimation
...
Embedded Systems Projects: Sensor interfacing, motor control, robot components.

2-Bluetooth Controlled Robotic Car: Arduino based car with Bluetooth control, motor drivers.
